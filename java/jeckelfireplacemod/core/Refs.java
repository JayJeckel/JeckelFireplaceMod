package jeckelfireplacemod.core;
...
import jeckelfireplacemod.proxy.CommonProxy;
...
public class Refs
{
	public static final String ModId = "jeckelfireplacemod";
	public static final String ModName = "JeckelFireplaceMod";
	...
	public static void pre(final Object modInstance, final FMLPreInitializationEvent event)
	{
		...
		NetworkRegistry.INSTANCE.registerGuiHandler(JeckelFireplaceMod.INSTANCE, new GuiHandler());

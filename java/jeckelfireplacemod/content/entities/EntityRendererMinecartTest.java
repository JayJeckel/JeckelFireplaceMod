...
public class EntityRendererMinecartTest extends Render
{
	private static final ResourceLocation minecartTextures = new ResourceLocation("textures/entity/minecart.png");
	/** instance of ModelMinecart for rendering */
	protected ModelBase modelMinecart = new ModelMinecartTest();
	protected final RenderBlocks _blockRender;

	public EntityRendererMinecartTest()
	{
		this.shadowSize = 0.5F;
		this._blockRender = new RenderBlocks();
	}
	...
	public void doRender(EntityMinecart p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		...
		if (block.getRenderType() != -1)
		{
			...
			GL11.glTranslatef(0.0F, ((float)k / 16.0F) - ((1.0F / 16.0F) * 2), 0.0F);
			this.renderBlock(p_76986_1_, p_76986_9_, block, j);
			GL11.glPopMatrix();
	...
	protected void renderBlock(EntityMinecart cart, float p_147910_2_, Block block, int meta)
	{
		float f1 = cart.getBrightness(p_147910_2_);
		GL11.glPushMatrix();
		this._blockRender.renderBlockAsItem(block, meta, f1);
		GL11.glPopMatrix();
	}
